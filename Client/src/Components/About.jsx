...
const About = () => {
  return (
    <div className=" w-screen bg-bgColor2 flex flex-col gap-4 items-center justify-center h-96">
      <div className="flex flex-col items-start   w-2/4 ">
        ...
        <p className=" text-start font-fontf3">
          ...
          apps using the MERN stack (MongoDB, Express.js, React.js, Node.js) for
          a while now. Continuously exploring and learning new technologies, I
          am driven to build impactful solutions and expand my skills in
          software development. in Computer Science and Engineering from
        </p>
      </div>
